...
class Piggy(PiggyParent):
    ...
    *************
    ...
    def __init__(self, addr=8, detect=True):
        ...
        self.SAFE_DIST = 350
        self.MIDPOINT = 1588  # what servo command (1000-2000) is straight forward for your bot?
        self.load_defaults()
    ...
    def menu(self):
        ...
        menu = {"n": ("Navigate", self.nav),
                ...
                "v": ("Veer", self.slither),
                "q": ("Quit", self.quit),
                "h": ("return to position", self.hold_position)
                }
    ...
    ****************
    ...
    while self.get_heading() != starting_direction:
        ...
        self.set_motor_power(self.MOTOR_RIGHT, right speed)
        time.sleep(.1)
    ...
    print("I can count how many obstacles are around me. Give my programmer an A+.")
